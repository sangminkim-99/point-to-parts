...
VARIANTS = {
    'guarded_recovery_ownership': ['incremental_pose=true', 'incremental_jump_only=true', 'recovery_contradicted_pose=true', 'recovery_exclude_owned=true'],
    'guarded_recovery_retry': ['incremental_pose=true', 'incremental_jump_only=true', 'recovery_contradicted_pose=true'],
